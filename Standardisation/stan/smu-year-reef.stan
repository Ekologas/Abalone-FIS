////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
// Title: Fixed SMU, Year by Reef
// Author: Steve Lane
// Date: Sunday, 01 April 2018
// Synopsis: This program fits a model within an SMU. It uses yearly
// catch/effort data to remove any month effects, and year by reef codes to
...
transformed parameters {
  ...
  for (j in 1:n) {
    real mu;
    /* Regression */
    mu = exp(intercept + log_effort[j] + reef_effect[reef[j]] + diver_effect[diver[j]] + year_effect[year[j]] + year_reef_effect[year[j], reef[j]]);
    /* Rate */
    beta[j] = alpha / mu;
  }
}
...
generated quantities {
  ...
  for (j in 1:n_pred_year) {
    ...
    new_mu = exp(intercept + new_reef + new_diver + year_effect[pred_year[j]] + new_reef_year);
